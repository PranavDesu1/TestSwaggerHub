...
{ 
    ...
    { 
        ...
        [HttpPost]
        [Route("/PranavDesu6/TestApi/1.0.0/user")]
        [ValidateModelState]
        ...
        /// <response code="0">successful operation</response>
        [HttpPost]
        [Route("/PranavDesu6/TestApi/1.0.0/user/createWithArray")]
        [ValidateModelState]
        ...
        /// <response code="0">successful operation</response>
        [HttpPost]
        [Route("/PranavDesu6/TestApi/1.0.0/user/createWithList")]
        [ValidateModelState]
        ...
        [HttpDelete]
        [Route("/PranavDesu6/TestApi/1.0.0/user/{username}")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/PranavDesu6/TestApi/1.0.0/user/loginn")]
        [ValidateModelState]
        ...
        /// <response code="0">successful operation</response>
        [HttpGet]
        [Route("/PranavDesu6/TestApi/1.0.0/user/logout")]
        [ValidateModelState]
